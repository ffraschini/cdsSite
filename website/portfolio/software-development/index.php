    ...
    <link rel="stylesheet" type="text/css" href="" />
	 <script>
        jQuery(document).ready(function () {
			iniciarSpinner();
            iniciarPorfolio();
			getWorkContainer('filterSoftw');		
			jQuery('.btn-all').css("background-position-y", "bottom");
			 jQuery('.btn-softw').css("background-position-y", "top");
			 jQuery('.btn-labs').css("background-position-y", "bottom");
			 jQuery('.btn-webportfolio').css("background-position-y", "bottom");
        ...
        <section id="SecPortfolio">
			...
			<div id="btnPortfolio" onload="alert('a'); getWorkContainer('filter')">
				<ul>
					...
					<li class="buttonPort btn-softw" onclick="goTo('')"></li>
					<li class="buttonPort btn-labs" onclick="goTo('../mobile-development')"></li>
					<li class="buttonPort btn-webportfolio" onclick="goTo('../web-developmen')"></li>
