			...
			<div class="min-900">
			    <div id="iconServices">
				    <ul>
					    ...
					    <li class="buttonServ icon-graphic" onclick="goTo('')" data-name="verServ4" ></li>
				    </ul>
			    </div>
				...
				<div id="serviceshide4">        <!-- Graphic design -->
				    <div id="firstlineServ4"></div>
				    <div id="txtServices">
					    <div class="close" onclick="ocultarServ('serviceshide4')"></div>
