			...
			<div class="min-900">
			    <div id="iconServices">
				    <ul>
					    ...
					    <li class="buttonServ icon-game" onclick="goTo('')" data-name="verServ5" ></li>
			    ...
			    <div id="serviceshide5">        <!-- Games -->
				    <div id="firstlineServ5"></div>
				    <div id="txtServices">
					    <div class="close" onclick="ocultarServ('serviceshide5')"></div>
