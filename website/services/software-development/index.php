    ...
    <div id="divServices">
        <section id="SecServices">
			...
			<div class="min-900">
			    <div id="iconServices">
				    <ul>
					    <li class="buttonServ icon-software" onclick="goTo('')" ></li>
					    <li class="buttonServ icon-mobile" onclick="goTo('../mobile-development')" data-name="verServ2"></li>
			    ...
			    <div id="serviceshide">        <!-- Software development / Programming & Maintenance -->
				    <div id="firstlineServ"></div>
				    <div id="txtServices">
					    <div class="close" onclick="ocultarServ('serviceshide')"></div>
				        ...
				        <p> <img src="img/tick.png"/> Problem Analysis 
						    ...
						    <br> <img src="img/tick.png"/> Implement (coding) the software
