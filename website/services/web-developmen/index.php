			...
			<div class="min-900">
			    <div id="iconServices">
				    <ul>
					    ...
					    <li class="buttonServ icon-web" onclick="goTo('')" data-name="verServ3"></li>
			    ...
			    <div id="serviceshide3">        <!-- Web development -->
				    <div id="firstlineServ2"></div>
				    <div id="txtServices">
					    <div class="close" onclick="ocultarServ('serviceshide3')"></div>
